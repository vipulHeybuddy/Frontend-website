      ...
      <div className=" mx-auto lg:w-[50%] py-32 sm:py-48 lg:py-56">
        <div style={{display:'flex', flexDirection: 'column' , alignItems: 'center'}} className="text-center">
          ...
          <Link
            ...
            >
          <div style={{width: 'fit-content'}}  className="rounded-3xl bg-[#3F8AE2] px-6 py-4 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-10 flex items-center justify-center gap-x-2">
            
             Let’s Discuss
           
            <span aria-hidden="true"  className="px-2 text-xl ">→</span>
          </div>
          </Link>
        </div>
      </div>
