...
const Grid2 = () => {
  return (
    <div className="bg-[url('../../public/Images/Ellipse5.png')] bg-no-repeat bg-auto bg-[center_top_1rem]">
      ...
      <div className="pt-[14px] lg:pt-[44px] ">
        ...
        <div>
          ...
          <div class="p-4 lg:p-2 lg:w-[60%]  grid mb-8 mx-auto text-center justify-center rounded-xl shadow-sm  md:mb-12 md:grid-cols-2">
            
            <figure class="flex flex-col  p-8  border-b border-gray-900 rounded-t-3xl md:rounded-t-none md:rounded-tl-3xl md:border-r h-full w-full bg-gray-600  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40">
            ...
            <figure class="flex flex-col items-center justify-center p-8 text-center  border-gray-900 rounded-br-3xl md:rounded-br-3xl h-full w-full bg-gray-600  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30">
              <blockquote class="max-w-2xl lg:py-8 mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <h3 class="text-5xl font-semibold text-gray-900 dark:text-white">
                  200+
                </h3>
