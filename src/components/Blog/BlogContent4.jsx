          ...
          <div className=" flex flex-col gap-14">
            ...
            <section className="flex flex-col gap-[30px] pb-[40px]">
              ...
              <div
                ...
                className="flex flex-col gap-5 text-white text-base font-light"
              >
                <h1 className="text-2xl font-extrabold">Types of CGI</h1>
              ...
              <div
                ...
                className="flex flex-col gap-5 text-white text-base font-light"
              >
                <h1 className="text-2xl font-extrabold">CGI Development</h1>
          ...
          <div className=" hidden lg:flex flex-col gap-5 sticky top-20">
            ...
            <div className=" text-white">
              ...
              >
                ...
                >
                  <a className="text-sm font-thin">Types of CGI</a>
                </h1>
                <h1
                  className="cursor-pointer pl-2"
                  onClick={() => handleNavClick("section5")}
                >
                  <a className="text-sm font-thin">CGI Development</a>
                </h1>
                <h1
                  className="cursor-pointer pl-2"
                  onClick={() => handleNavClick("section6")}
                >
                  <a className="text-sm font-thin">Bad CGI vs Good CGI.</a>
                </h1>
                <h1
                  className="cursor-pointer pl-2"
