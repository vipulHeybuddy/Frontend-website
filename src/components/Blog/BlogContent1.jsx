          ...
          <div className=" flex flex-col gap-14">
            ...
            <section className="flex flex-col gap-[30px] pb-[40px]">
              ...
              >
                ...
                <p class="font-semibold">Games Genre: </p>
                <p className="text-sm font-thin">Battle Royale Games.</p>
                <p class="font-semibold">USP/Expertise: </p>
                <p className="text-sm font-thin">
                ...
                <p class="font-semibold">Market Segment: </p>
                <p className="text-sm font-thin">High-end console Games.</p>
                <p class="font-semibold">Audience: </p>
                <p className="text-sm font-thin">
                ...
                <p class="font-semibold">Expertise Platforms: </p>
                <p className="text-sm font-thin">PlayStation consoles</p>
              </div>
              <div
                id="section3"
                className="flex flex-col gap-5 text-white text-base font-light"
              ...
              >
                ...
                <p className="text-sm font-thin">
                  <ul className=" list-disc">
                    <li className="text-sm font-thin">Games genre</li>
                    <li className="text-sm font-thin">Platform</li>
                    <li className="text-sm font-thin">Target audience</li>
                    <li className="text-sm font-thin">
