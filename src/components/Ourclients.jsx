  ...
  return (
    ...
    <h3>Listen from our clients</h3>
      ...
      <div class="p-2 lg:p-12 w-[90%] lg:w-[80%]  grid mx-auto text-center justify-center rounded-xl shadow-sm sm:grid-1 md:mb-12 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-4">
        ...
        <figure class="flex flex-col items-center justify-center p-2 lg:p-4 text-center border-2 border-gray-500 rounded-lg h-full w-full bg-gray-700  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
        ...
        <figure class="flex flex-col items-center justify-center p-2 lg:p-4 text-center border-2 border-gray-500 rounded-lg h-full w-full bg-gray-800  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
          <blockquote class="max-w-2xl mx-auto text-gray-500 dark:text-gray-400">
