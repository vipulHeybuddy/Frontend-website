...
const Section8 = () => {
  ...
  return (
    ...
    >
       <div className="py-8 lg:w-[80%] text-white mx-auto text-center">
        <h1 className="py-4 font-bold text-2xl lg:text-4xl">
        How we did it?
        </h1>
        <p className="text-xl lg:text-2xl  ">
        Lorem ipsum dolor sit amet consectetur. Volutpat pretium malesuada dignissim justo ut est cursus. Faucibus in malesuada et et. Ac semper ac nec lectus. Aenean.        </p>
      </div>
