...
const Sliderclient = () => {
  ...
  useEffect(() => {
    ...
    const List = [
        {
          id: "1",
          heading: "Immersive VR Application Development",
          imgurl: "",
          para: "We craft captivating virtual reality applications across diverse platforms. Be assured of a seamless and immersive user experience that aligns with your specific requirements.",
        },
        {
          id: "2",
          heading: "Engaging VR Game Development",
          imgurl: "",
          para: "We have a dedicated team of game-crazy expert developers. They deliver complete virtual reality games with innovation, creativity, and cross-platform compatibility.",
        },
        {
          id: "3",
          heading: "Metaverse VR Development Services",
          imgurl: "",
          para: "Discover the metaverse like never before with Hey Buddy's expert touch. Get tailored solutions for Roblox adventures to redefine social connections in Sansar.",
        },
        {
          id: "4",
          heading: "360° Video Production for VR Experiences",
          imgurl: "",
          para: "We let you immerse your audience in captivating 360-degree videos. Our expertise in capturing and producing high-quality VR environments creates a new reality.",
        },
        {
          id: "5",
