  ...
  return (
    ...
    >
        ...
        {List.map((section, index) => (
          ...
          <figure style={{maxHeight: '45vh', overflow: 'auto' , height: '45vh'  }} class="flex flex-col p-4 lg:p-6  rounded-lg  h-full w-full bg-gray-400  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 scrollbar-hide">
